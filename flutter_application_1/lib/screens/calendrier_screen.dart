...
class _CalendrierLogistiqueScreenState
      ...
      body: isLoading
          ...
          : LayoutBuilder(
              builder: (context, constraints) {
                // Adaptation responsive basée sur la taille d'écran
                ...
                return SingleChildScrollView(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      // Header avec adaptation responsive
                      _buildResponsiveHeader(isSmallScreen),
                      const SizedBox(height: 24),
                      // Navigation calendrier et grille
                      _buildCalendarContainer(isSmallScreen, isMediumScreen),
                      const SizedBox(height: 24),
                      // Statistiques avec adaptation responsive
                      _buildResponsiveStatistics(isSmallScreen, isMediumScreen),
                    ],
                  ),
                );
              },
  ...
  Widget _buildCalendarContainer(bool isSmallScreen, bool isMediumScreen) {
    return Container(
      width: double.infinity,
      padding: EdgeInsets.all(isSmallScreen ? 16 : 24),
      decoration: BoxDecoration(
      ...
      child: Column(
        children: [
          // Navigation mois avec adaptation responsive
          _buildResponsiveMonthNavigation(isSmallScreen),
          const SizedBox(height: 24),
          ...
          const SizedBox(height: 8),
          _buildResponsiveCalendarGrid(isSmallScreen),
        ],
      ),
    );
  }

  Widget _buildResponsiveMonthNavigation(bool isSmallScreen) {
    if (isSmallScreen) {
      return Column(
        children: [
          Text(
  ...
  Widget _buildResponsiveCalendarGrid(bool isSmallScreen) {
    ...
    // Calcul de la hauteur adaptative pour les cellules
    double cellHeight = isSmallScreen ? 80 : 100;
              ...
              children: [
                ...
                Expanded(
                  child: SingleChildScrollView(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: dayEvents.take(isSmallScreen ? 2 : 3).map((event) {
                        return Container(
                          width: double.infinity,
  ...
  Widget _buildResponsiveStatistics(bool isSmallScreen, bool isMediumScreen) {
    ...
    double childAspectRatio = isSmallScreen ? 3.5 : 2.5;
