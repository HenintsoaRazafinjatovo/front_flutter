...
class MaterielScreen extends StatelessWidget {
  ...
  home: const AuthGuard(child: GestionMaterielsPage()),
);
  }
}
                          ...
                          return ConstrainedBox(
                            ...
                            child: SingleChildScrollView(
                              ...
                              child: ConstrainedBox(
                                ...
                                child: DataTable(
                                  columnSpacing: 12, // Réduit l'espacement entre les colonnes
                                  horizontalMargin: 12, // Réduit la marge horizontale
                                  headingRowColor: WidgetStateProperty.all(headerRowColor),
                                  headingTextStyle: TextStyle(
                                    color: const Color.fromARGB(255, 58, 57, 57),
                                    fontWeight: FontWeight.bold,
                                    fontFamily: 'Poppins',
                                    fontSize: 14, // Réduit légèrement la taille de police des en-têtes
                                  ),
                                  dataTextStyle: TextStyle(
                                    fontFamily: 'Poppins',
                                    fontSize: 13, // Réduit légèrement la taille de police des données
                                  ),
                                  columns: [
                                    DataColumn(
                                      label: Container(
                                        width: constraints.maxWidth * 0.18, // 18% au lieu de 16.6%
                                        child: Text(
                                          'Désignation',
                                          style: TextStyle(fontFamily: 'Poppins'),
                                        ),
                                    ...
                                    DataColumn(
                                      label: Container(
                                        width: constraints.maxWidth * 0.12, // 12% pour le code
                                        child: Text(
                                          'Code',
                                          style: TextStyle(fontFamily: 'Poppins'),
                                        ),
                                    ...
                                    DataColumn(
                                      label: Container(
                                        width: constraints.maxWidth * 0.18, // 18% pour la nature
                                        child: Text(
                                          'Nature',
                                          style: TextStyle(fontFamily: 'Poppins'),
                                        ),
                                    ...
                                    DataColumn(
                                      label: Container(
                                        width: constraints.maxWidth * 0.20, // 20% pour les actions
                                        child: Text(
                                          'Actions',
                                          style: TextStyle(fontFamily: 'Poppins'),
                                        ),
